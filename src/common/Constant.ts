...
export const bodyConfigs: BodyConfigs = {
  ...
  outHarvester: getBodyConfig(
    ...
    { [WORK]: 2, [CARRY]: 4, [MOVE]: 8 },
    { [WORK]: 4, [CARRY]: 6, [MOVE]: 12 },
    { [WORK]: 8, [CARRY]: 6, [MOVE]: 14 },
    { [WORK]: 8, [CARRY]: 10, [MOVE]: 20 },
    { [WORK]: 8, [CARRY]: 10, [MOVE]: 20 },
    { [WORK]: 8, [CARRY]: 10, [MOVE]: 20 }
  ),
  ...
  remoteCarryer: getBodyConfig(
    { [CARRY]: 20, [WORK]: 1, [MOVE]: 11 },
    { [CARRY]: 20, [WORK]: 1, [MOVE]: 11 },
    { [CARRY]: 20, [WORK]: 1, [MOVE]: 11 },
    { [CARRY]: 10, [WORK]: 1, [MOVE]: 12 },
    { [CARRY]: 16, [WORK]: 1, [MOVE]: 18 },
    { [CARRY]: 16, [WORK]: 1, [MOVE]: 18 },
    { [CARRY]: 20, [WORK]: 1, [MOVE]: 11 },
    { [CARRY]: 20, [WORK]: 1, [MOVE]: 11 },
  ),
